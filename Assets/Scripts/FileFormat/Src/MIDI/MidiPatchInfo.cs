...
{
    public static class MidiPatchInfo
    {
        public static bool GetPatchName(int patch, out string name)
        {
            return midiInstruments.TryGetValue(patch + 1, out name);
        }

        public static Dictionary<int, string> midiInstruments = new()
        {
